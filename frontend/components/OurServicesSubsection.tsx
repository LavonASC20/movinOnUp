...
export const OurServicesSubsection = (): JSX.Element => {
  ...
  return (
    <section className="w-full bg-white pt-[100px]">
      ...
      <div className="container flex flex-col items-center py-16 pl-[75px] pr-[75px]">
        {/* Section Title */}
        ...
        {/* Description */}
        <div className="w-full max-w-[1253px] mb-12 font-normal italic text-black text-xl text-center leading-[30px]">
          ...
          <div className = "flex flex-col gap-8">
            <ExpandableCard 
              ...
              img = {<Image 
                        src={mathBackground} 
                        alt="Math Symbol" 
                        className="ml-2 inline-block w-full h-full object-contain"
                        width={1024} 
                        height={1024}
                      />}
              collapsedContent = {
