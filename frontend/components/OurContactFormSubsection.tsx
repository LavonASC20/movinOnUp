...
export const OurContactFormSubsection = (): JSX.Element => {
  ...
  return (
    <section className="w-full bg-white pt-[125px] pb-[125px]">
      <NavbarSubsection />
      <div className="max-w-2xl mx-auto p-6 border rounded-xl shadow-lg">
        ...
        <p className="text-sm italic text-black text-center mb-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <textarea
            ...
            value={form.message}
            onChange={handleChange}
            className="w-full border px-4 py-2 rounded min-h-[120px] text-black"
            required
          />
          <button
            type="submit"
